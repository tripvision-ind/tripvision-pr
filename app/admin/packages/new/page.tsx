  ...
  useEffect(() => {
    ...
    fetch("/api/admin/currencies")
      ...
      .then((data) => {
        ...
        const defaultCurrency = currencyList.find((c: Currency) => c.isDefault);
        if (defaultCurrency) {
          setPrices([
            { currencyId: defaultCurrency.id, price: "", discountedPrice: "" },
          ]);
        }
      })
      .catch(console.error);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Create a comprehensive travel package
            </p>
          </div>
        </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {bookingDates.length === 0 && (
                    <p className="text-center text-muted-foreground py-4">
                      No booking dates added. Click &quot;Add Date&quot; to add
                      available dates.
                    </p>
                  )}
                </CardContent>
